...
#PHP 5.4.X
readonly PHP_54_FILE=php-5.4.43.tar.bz2
...
#PHP 5.5.X
readonly PHP_55_FILE=php-5.5.27.tar.xz
...
#PHP 5.6.X
readonly PHP_56_FILE=php-5.6.11.tar.xz
...
readonly EXT_PHALCON_URL=https://github.com/phalcon/cphalcon/archive/phalcon-v2.0.4.tar.gz
